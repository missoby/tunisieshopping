$(document).ready(function(){
   var url = document.URL; // Get current url
    ...
    $.ajax({
        ...
        dataType: 'json',
        //cache: false,
        url: 'http://tunisieshopping.orgfree.com/mobile/listprodmobile/suiviprod/',
        //   url: 'http://localhost:8081/mobile/listprodmobile/listprod',
                     
        success: function(data){ 
            if (data['produit'].length == 0) {
                $('#commentaire').append('<li data-role="fieldcontain"><p style="white-space: normal;"> Aucun achat n\'a �t� effectuer</p></li>');
            }
            else{
